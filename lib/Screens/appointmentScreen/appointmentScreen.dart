import 'package:dokter/Screens/appointmentDetailScreen/AppointmentDetailScreen.dart';
import 'package:flutter/foundation.dart';
import 'package:flutter_staggered_animations/flutter_staggered_animations.dart';
import 'package:dokter/WidgetComponents/MiniAppointmentCard.dart';
import 'package:dokter/WidgetComponents/AppointmentCard.dart';
import 'package:dokter/WidgetComponents/SlidingCard.dart';
import 'package:dokter/Logic/AppointmentManager.dart';
...
class _AppointmentScreenState extends State<AppointmentScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: const Color(0xffF3F6FF).withOpacity(0.134),
        elevation: 0,
        leading: Icon(
          Icons.menu,
      ...
      body: isLoading
          ? const SizedBox()
          : Container(
              color: const Color(0xffF3F6FF).withOpacity(0.134),
  ...
  Future<bool> initiateList() async {
    ...
    for (var anElement in AppointmentManager.appointmentList) {
      if (anElement.isFuture == false) {
        ...
        SlidingCardController aController = SlidingCardController();
        if (kDebugMode) {
